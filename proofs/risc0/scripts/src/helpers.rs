...
use cloakwork_risc0_lib::rr::dns_class::DNSClass as ZKDNSClass;
use cloakwork_risc0_lib::rr::dnssec::algorithm::Algorithm as ZKAlgorithm;
use cloakwork_risc0_lib::rr::dnssec::rdata::sig::SIG as ZKSIG;
use cloakwork_risc0_lib::rr::domain::name::Name as ZKName;
use cloakwork_risc0_lib::rr::rdata::txt::TXT as ZKTXT;
use cloakwork_risc0_lib::rr::record_type::RecordType as ZKRecordType;
use cloakwork_risc0_lib::rr::resource::Record as ZKRecord;
