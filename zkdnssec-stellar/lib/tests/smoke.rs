//! Smoke test for `zkdnssec-lib` — proves the crypto core that the rest of
...
//! over unchanged. Run with: `cargo test -p zkdnssec-lib`.

use ecdsa::signature::Signer;
use p256::ecdsa::{Signature, SigningKey};
use rand_core::OsRng;
use zkdnssec_lib::verify_ecdsa_signature;
